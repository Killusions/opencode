          ...
          if (
            ...
            const text =
              (input.overflow
                ...
                : "") +
              "Continue if you have next steps, or stop and ask for clarification if you are unsure how to proceed. Please also check the todo list for any remaining tasks."
            yield* session.updatePart({
              id: PartID.ascending(),
