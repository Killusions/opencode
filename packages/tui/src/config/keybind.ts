...
export const Definitions = {
  ...
  session_subagent_prompt: keybind("p", "Prompt selected subagent"),
  session_subagent_cancel: keybind("x", "Cancel selected subagent"),
  session_subagent_toggle_preview: keybind("tab", "Toggle selected subagent preview"),
  session_subagent_inspect: keybind("return", "Inspect selected subagent"),
...
export const CommandMap = {
  ...
  session_subagent_prompt: "session.subagent.prompt",
  session_subagent_cancel: "session.subagent.cancel",
  session_subagent_toggle_preview: "session.subagent.toggle_preview",
  session_subagent_inspect: "session.subagent.inspect",
